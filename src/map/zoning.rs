...
impl TerrainType {
    pub fn traits(&self) -> SedimentTraits {
        match self {
            TerrainType::Grass => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: true, allow_plants: true, allow_ores: true },
            TerrainType::Dirt => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: false, allow_plants: true, allow_ores: true },
            TerrainType::Dusty => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: false, allow_plants: true, allow_ores: true },
            TerrainType::Fertile => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: true, allow_plants: true, allow_ores: true },
            TerrainType::Mossy => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: true, allow_plants: true, allow_ores: true },
            TerrainType::Steppe => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: false, allow_plants: true, allow_ores: true },
            TerrainType::Stony => SedimentTraits { allow_buildings: true, allow_mining: true, allow_forests: false, allow_plants: false, allow_ores: true },
            TerrainType::Swamp => SedimentTraits { allow_buildings: false, allow_mining: true, allow_forests: false, allow_plants: false, allow_ores: true },
        }
    }
}
