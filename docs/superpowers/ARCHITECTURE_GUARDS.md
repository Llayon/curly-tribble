...
Этот документ описывает 29 паттернов и правил, которые автоматически проверяются в проекте "Ant Farm: Dark Narrative" для поддержания стандарта **Absolute Zenith**.
